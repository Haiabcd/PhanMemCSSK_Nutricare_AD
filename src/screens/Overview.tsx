...
function normalize(raw: RawOverview): OverviewUi {
  ...
  return {
    ...
    getPlanLogCountByMealSlot: raw.getPlanLogCountByMealSlot || {
      BREAKFAST: 0,
      LUNCH: 0,
      DINNER: 0,
      SNACK: 0,
...
export default function Overview() {
  ...
  useEffect(() => {
    ...
    fetchOverview(ac.signal)
      ...
      .catch((err: unknown) => {
        ...
        console.error("Overview API error:", toAxiosMessage(err));
        setOv(null);
      })
  ...
  const donutByMealSlot = useMemo(
    () => [
      {
        label: "Bữa sáng",
        value: ov?.getPlanLogCountByMealSlot.BREAKFAST ?? 0,
      },
